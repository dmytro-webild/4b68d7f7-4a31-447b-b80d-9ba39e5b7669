...
export default function LandingPage() {
  ...
  <div id="experience" data-section="experience">
      ...
      metrics={[
        {
          icon: Coffee,
          label: "The Coffee",          value: "Expertly Brewed"},
        {
          icon: Sparkles,
          label: "The Vibe",          value: "Cozy Aesthetic"},
        {
          icon: Utensils,
          label: "The Food",          value: "Daily Favorites"},
      ]}
  ...
  <div id="insta" data-section="insta">
      ...
      useInvertedBackground={false}
      names={[
        "@mugshot_insta",        "@mugshot_life",        "@nyali_coffee",        "@mombasa_eats",        "@daily_mugshot",        "@latte_art_co",        "@mugshot_ritual"]}
