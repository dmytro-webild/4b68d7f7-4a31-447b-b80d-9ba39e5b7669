...
export default function LandingPage() {
      ...
      metrics={[
        {
          icon: Coffee,
          label: "The Coffee",
          value: "Expertly Brewed",
        },
        {
          icon: Sparkles,
          label: "The Vibe",
          value: "Cozy Aesthetic",
        },
        {
          icon: Utensils,
          label: "The Food",
          value: "Daily Favorites",
        },
      ]}
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          ...
          price: "KSh 400",
          imageSrc: "http://img.b2bpic.net/free-photo/round-plate-with-fresh-croissants-healthy-macadamia-nuts_114579-36695.jpg",
          imageAlt: "Signature Fries",
        },
        {
          id: "p5",
          name: "House Mocktail",
          ...
          imageAlt: "House Mocktail",
        },
        {
          id: "p6",
          name: "Daily Pastry",
          price: "KSh 350",
          imageSrc: "http://img.b2bpic.net/free-photo/pork-chop-chicken-steak_74190-592.jpg",
          imageAlt: "Daily Pastry",
        },
      ]}
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/portrait-pretty-girl-with-long-hair-sittting-table-terrace-cafe-she-wears-white-dress-with-bare-shoulders-red-lipstick-she-has-fun-front-camera_197531-24908.jpg",
          alt: "Emily",
        },
        {
          src: "http://img.b2bpic.net/free-photo/young-beautiful-businesswoman-discussing-work-issues-with-colleagues-by-video-call-using-laptop-coffee-break-courtyard-cafe_574295-3003.jpg",
          alt: "David",
        },
        {
          src: "http://img.b2bpic.net/free-photo/couple-drinking-beverage-cafe-together_53876-26419.jpg",
          alt: "Jane",
        },
      ]}
      ...
      features={[
        {
          ...
          descriptions: [
            "Located right on Links Road, easy to access from all corners of Nyali.",
          ],
          imageSrc: "http://img.b2bpic.net/free-photo/pretty-girl_1157-7129.jpg",
        },
        {
          id: "loc-2",
          title: "Flexible Hours",
          descriptions: [
            "Early morning coffee to late night cravings, we've got you covered.",
          ],
          imageSrc: "http://img.b2bpic.net/free-photo/waitress-serving-coffee_23-2147985019.jpg",
        },
        {
          id: "loc-3",
          title: "Seamless Service",
          descriptions: [
            "Dine-in, quick takeaway, or delivery to your doorstep.",
          ],
  ...
  <div id="contact" data-section="contact">
      ...
      mediaAnimation="slide-up"
      inputPlaceholder="Enter your email for perks"
    />
  </div>
  ...
  <div id="footer" data-section="footer">
      ...
      bottomLeftText="© 2024 Mugshot Cafe."
      bottomRightText="Built in Mombasa."
    />
  </div>
      </ReactLenis>
    </ThemeProvider>
